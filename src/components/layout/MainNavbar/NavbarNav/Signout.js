...
import { faHome, faReply, faRotate, faSignOutAlt } from '@fortawesome/free-solid-svg-icons'
...
export default class Signout extends React.Component {
  ...
  <NavItem className="border-right dropdown form-inline" style={{left:"0"}}>
         <NavLink
          className="nav-link-icon text-center"
          onClick={this.toggleNotifications}>
          <div className="nav-link-icon__wrapper text-nowrap px-3 mt-2">
            {/* <span className="mr-2" style={{fontFamily:"cinema" , fontSize:"15pt" , color:"#6f0a9d"}}>بازگشت </span> */}
